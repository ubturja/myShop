          ...
          {filteredProducts.map((product) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden bg-bg-dark-3 scan-line">
                <img
                  src={product.image_url || `https://source.unsplash.com/featured/400x300/?${product.category},tech,neon`}
                  alt={product.title}
                  className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110"
                  onError={(e) => {
                    const target = e.target as HTMLImageElement;
                    target.src = 'https://source.unsplash.com/featured/400x300/?cyberpunk,tech';
                  }}
                />
